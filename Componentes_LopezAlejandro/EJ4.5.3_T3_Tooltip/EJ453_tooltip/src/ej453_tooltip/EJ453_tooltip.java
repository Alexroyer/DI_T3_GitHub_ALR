 ...
 * @author Alejandro
 */
public class EJ453_tooltip extends Application{
    ...
    public void start(Stage stage) {
        ...
        //HE PUESTO UNA HOJA CSS, ME FALTA CREARLA Y DEFINIRLA
        Scene scene = new Scene(new Group(), 500, 400);
        scene.getStylesheets().add("ej453_tooltip/tooltip.css");
